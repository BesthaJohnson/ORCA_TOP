...
#set_input_delay -clock clock  0.3 [remove_from_collection [all_inputs] clock]
#set_output_delay -clock clock 0.7 [all_outputs]
...
###FLOORPLAN
initialize_floorplan -core_utilization 0.65 -core_offset {10 15 10 15} -side_ratio {1 2}
place_pins -self
